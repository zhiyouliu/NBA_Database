...
$HOMEABBWIN = $_POST['HOMEABBWIN'];
$AWAYABBWIN = $_POST['AWAYABBWIN'];
...
$query = mysqli_multi_query($conn, "CALL attempt1('".$D."','".$HOMEABB."','".$AWAYABB."','".$HOMEABBWIN."','".$AWAYABBWIN."','".$IP_PASS."','".$HOMESCORE."','".$AWAYSCORE."','".$SEASON."')");
